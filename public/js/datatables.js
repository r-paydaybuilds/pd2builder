 ...
 *   https://datatables.net/download/#bs/jq-2.1.4,dt-1.10.10,b-1.1.0,b-colvis-1.1.0,cr-1.3.0,fh-3.1.0,r-2.0.0,rr-1.1.0,sc-1.4.0,se-1.1.0
 *
 * Included libraries:
 *   jQuery 2.1.4, DataTables 1.10.10, Buttons 1.1.0, Column visibility 1.1.0, ColReorder 1.3.0, FixedHeader 3.1.0, Responsive 2.0.0, RowReorder 1.1.0, Scroller 1.4.0, Select 1.1.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs/jq-2.1.4,dt-1.10.10,b-1.1.0,b-colvis-1.1.0,cr-1.3.0,fh-3.1.0,r-2.0.0,rr-1.1.0,sc-1.4.0,se-1.1.0",
...
apiRegisterPlural( 'rows().deselect()', 'row().deselect()', function ( deselect ) {
	var api = this;
...
apiRegisterPlural( 'columns().deselect()', 'column().deselect()', function ( deselect ) {
	var api = this;
...
apiRegisterPlural( 'cells().deselect()', 'cell().deselect()', function ( deselect ) {
	var api = this;
...
/*
     FILE ARCHIVED ON 00:27:23 Nov 29, 2018 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 16:08:21 Jan 28, 2019.
...
playback timings (ms):
  ...
  esindex: 0.01
  captures_list: 83.214
  CDXLines.iter: 10.324 (3)
  PetaboxLoader3.datanode: 106.162 (5)
  exclusion.robots: 0.227
  exclusion.robots.policy: 0.211
  RedisCDXSource: 1.598
  PetaboxLoader3.resolve: 55.878 (2)
