...
self.addEventListener("fetch", async ev => {
    ...
    if(match === undefined) {
        ev.respondWith(fetch(ev.request.clone())
            .then(r =>
                caches.open("v1").then(cache => {
